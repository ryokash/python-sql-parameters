...
_NAMED_STYLE_NAMED = re.compile(':([A-Za-z_]\\w*)')
...
#: Regular expression used to match "sqlserver" style parameters.
_NAMED_STYLE_SQLSERVER = re.compile('@[A-Za-z_]\\w*')
...
_LOOKUP_NAMED_STYLE = {
    ...
    'sqlserver': _NAMED_STYLE_SQLSERVER,
}
